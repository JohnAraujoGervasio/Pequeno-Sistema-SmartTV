...
* **Classes e Objetos:** A estrutura da `SmartTV` servindo como molde para a criação de instâncias.
* **Atributos:** Gerenciamento de estado (ex: `ligada`, `canal`, `volume`).
* **Métodos:** Implementação de comportamentos para manipular os atributos.
* **Interação entre Classes:** A classe `Usuario` atuando como o driver do sistema para interagir com o objeto.
